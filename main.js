...
CalculatorsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CalculatorsComponent, selectors: [["app-calculators"]], decls: 8, vars: 0, consts: [[1, "primaryColorBG", 2, "text-align", "center", "height", "50rem"], [1, "card-body", 2, "width", "80%", "display", "inline-block"], ["label", "Stock Return Calculator"], ["label", "calc2"], [2, "height", "45rem", "line-height", "45rem"]], template: function CalculatorsComponent_Template(rf, ctx) { if (rf & 1) {
...
StockReturnCalculatorComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: StockReturnCalculatorComponent, selectors: [["app-stock-return-calculator"]], viewQuery: function StockReturnCalculatorComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵNgOnChangesFeature"]], decls: 49, vars: 21, consts: [["color", "primary", 1, "primaryColorBG"], ["appearance", "fill", 2, "margin-right", "10px", "height", "10px"], ["appearance", "fill", 3, "selectionChange"], [3, "value", 4, "ngFor", "ngForOf"], ["appearance", "fill", 1, "primaryColorBG", 2, "margin-right", "10px"], ["matInput", "", "value", "1930-05-04", 3, "matDatepicker", "change"], ["matSuffix", "", 3, "for"], ["pickerFrom", ""], ["matInput", "", "value", "2020-07-20", 3, "matDatepicker", "change"], ["pickerTo", ""], ["appearance", "fill", "matTooltip", "The intervals displayed on the graph. Ex. .5 will show every range of .5 percent", 2, "width", "10%", "height", "10px", "margin-right", "10px"], [3, "selectionChange"], ["appearance", "fill", 2, "width", "57px", "margin-right", "10px"], ["matInput", "", "value", "30", "matTooltip", "the number of years in each interval analyzed", 3, "change"], ["mat-raised-button", "", "color", "accent", 3, "click"], [2, "width", "50%"], [1, "accentColorBG"], [1, "primaryColorBG", 2, "width", "95%", "height", "32rem"], [1, "primaryColorBG", 2, "text-align", "center"], [1, "card-body"], [2, "width", "100%", "height", "100%"], ["label", "bar graph", 2, "width", "100%", "height", "100%"], [3, "view", "scheme", "results", "gradient", "xAxis", "yAxis", "legend", "showXAxisLabel", "showYAxisLabel", "xAxisLabel", "yAxisLabel"], ["label", "box and whisker plot"], [3, "value"]], template: function StockReturnCalculatorComponent_Template(rf, ctx) { if (rf & 1) {
